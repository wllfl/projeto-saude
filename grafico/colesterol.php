...
<html>
	<head>
		...
		<link href="http://www.wllsistemas.com.br/ProjetoSaude/css/estilo.css" rel="stylesheet" type="text/css"/>
		<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
		<script src="http://www.wllsistemas.com.br/ProjetoSaude/js/highcharts.js"></script>
		<script src="http://www.wllsistemas.com.br/ProjetoSaude/js/modules/exporting.js"></script>
		...
		$(function () {
			...
			$('#container5').highcharts({
				...
				title: {
					text: 'Colesterol Elevado - (Fazem Traramento)',
					style:{
							color: '#3E576F',
							fontSize: '14px'
					}
